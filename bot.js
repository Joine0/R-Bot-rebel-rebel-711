...
R-rainbow ⇏  لتشغيل الرتبة متغيرةة اللون
لتشغيل الرينبو يجب وضع رتبة البوت فوق الرتبة المراد وضعها رينبو
-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
R-inv ⇏  لدعوة آلبوت لسيرفرك
...
client.on('guildCreate', guild => {
  ...
  .setColor(000000)
            .addField(`R-Bot .`, 'شكرآ لتعآملك مع بوتنآ وإدخآله سيرفرك');
